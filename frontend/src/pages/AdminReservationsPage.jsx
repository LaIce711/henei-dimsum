            ...
            <div key={reservation._id} className="reservation-card">
              ...
              <div className="card-body">
                ...
                {reservation.items && reservation.items.length > 0 && (
                  <div className="reservation-items" style={{ marginTop: '15px', padding: '10px', background: '#f9f9f9', borderRadius: '8px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                      <strong style={{ color: '#d32f2f' }}>🍲 Món đặt trước:</strong>
                      {reservation.servingTime && (
                        <span style={{ fontSize: '0.9rem', color: '#666' }}>
                          🕒 Lên món lúc: <strong>{reservation.servingTime}</strong>
                        </span>
                      )}
                    </div>
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                      {reservation.items.map((item, idx) => (
                        <li key={idx} style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px dashed #eee' }}>
